...
export const generateOSINTPDF = async (eyeconDetails, truecallerDetails, mobNo, upiDetails, userPhoneNumber) => {
    try {
        ...
        doc.text(`Report Generated by: ${userPhoneNumber}`, 20, imgHeight + 55);
 ...
 The information in this Open Source Intelligence (OSINT) report is derived from publicly available data and online sources as of the creation date. The accuracy, completeness, and reliability of this information may vary and cannot be guaranteed. This report is for informational purposes only and does not constitute legal, professional, or expert advice.

 The findings and conclusions in this report are based on an analysis of publicly accessible information and do not include any confidential or proprietary data. The recipient acknowledges that the information may change over time, and any actions taken based on this report are at the recipient's own risk.

 This report is not intended to infringe on any individual's privacy rights or violate any laws or regulations. The recipient is responsible for using the information responsibly and in compliance with all applicable laws, regulations, and ethical guidelines.

 Garuda Intelligence and its affiliates disclaim all liability for any direct, indirect, or consequential losses or damages arising from the use or reliance on the information provided in this report. The recipient is encouraged to independently verify the information and seek professional advice if needed.
 `;
        const disclaimerLines = doc.splitTextToSize(disclaimer, 180);
        doc.text(disclaimerLines, 10, 10);
